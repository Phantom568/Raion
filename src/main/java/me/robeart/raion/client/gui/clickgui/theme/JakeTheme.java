...
public class JakeTheme extends GLUtils implements Theme {
  ...
  public void mainPanelDraw(MainPanel mainPanel, float mouseX, float mouseY) {
    ...
    String leftTitle = "JakeHack " + Raion.VERSION;
  ...
  public void buttonDraw(Button button, float x, float y, float mouseX, float mouseY, CategoryPanel categoryPanel) {
    ...
    drawRect(x, y, categoryPanel.width, 13, hovering ? new Color(100, 100, 100, 100) : new Color(0, 187, 255, 100));
  ...
  public boolean equals(Object o) {
    ...
    JakeTheme jakeTheme = (JakeTheme) o;
    return name.equals(jakeTheme.name);
  }
